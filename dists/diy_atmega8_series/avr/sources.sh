...
function main
{
  ...
  wget https://raw.githubusercontent.com/arduino/ArduinoCore-avr/master/platform.txt -O        platform.tmp.txt  
  cat >platform.txt <<EOF
###############################################################################
#
# This platform.txt has been created from the combination of 
# https://github.com/arduino/ArduinoCore-avr/master/platform.txt
...
EOF
  ...
  then  
    # Our avrdude.local.conf is an entire avrdude.conf
